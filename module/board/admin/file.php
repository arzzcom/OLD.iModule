													...
													new Ext.Window({
														...
														listeners:{show:{fn:function() {
															if (Ext.getCmp("RetrenchForm").getForm().findField("all").checked == true) {
																...
																execFrame.location.href = "<?php echo $_ENV['dir']; ?>/module/board/exec/Admin.do.php?action=file&do=retrench&date="+Ext.getCmp("RetrenchForm").getForm().findField("year").getValue()+""+Ext.getCmp("RetrenchForm").getForm().findField("month").getValue();
															}
