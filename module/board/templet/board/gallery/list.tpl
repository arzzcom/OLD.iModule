...
<div id="tList">
	...
	{foreach name=list from=$data item=data}
		...
		<td>
			...
			<div class="thumbnail" style="background-image:url({mBoard->GetThumbnail post=$data width=176 height=0 min_height=110 error=$skinDir|cat:'/images/noimage.gif'})" onclick="location.href='{$data.postlink}';"></div>
			<table cellpadding="0" cellspacing="0" class="layoutfixed">
