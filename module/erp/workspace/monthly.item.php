		...
		items:[
			new Ext.grid.EditorGridPanel({
								...
								items:[
									new Ext.grid.GridPanel({
										...
										store:new Ext.data.Store({
											...
											baseParams:{"wno":"<?php echo $this->wno; ?>","action":"monthly","get":"item","mode":"load","date":Ext.getCmp("month").getValue(),"load":""}
										})
									})
								],
								buttons:[
					...
					new Ext.Button({
						...
						handler:function() {
							...
							Ext.Ajax.request({
								...
								headers:{},
								params:{"action":"monthly","do":"item","mode":"save","wno":"<?php echo $this->wno; ?>","date":Ext.getCmp("month").getValue(),"data":data}
							});
						}
					})
				],
				...
				store:new Ext.data.GroupingStore({
					...
					baseParams:{"wno":"<?php echo $this->wno; ?>","action":"monthly","get":"item","mode":"list","date":"<?php echo Request('iErpMonth','cookie') != null ? Request('iErpMonth','cookie') : GetTime('Y-m'); ?>"}
				}),
				autoScroll:true,
				trackMouseOver:true,
