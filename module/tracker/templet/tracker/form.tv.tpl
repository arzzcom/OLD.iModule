...
<tr>
	...
	<td class="content">
		<div style="position:relative; width:600px;">
			<input type="text" id="TrackerGroupSearchInput" onfocus="TrackerGroupLiveSearchStart({$category},'daumtv');" onblur="TrackerGroupLiveSearchEnd();" autocomplete="off" onkeydown="TrackerGroupLiveSearchListMove(event)" class="inputbox" style="width:594px;" artist="감독" subartist="출연" />
		...
		<div class="formInfo">
			다음TV프로그램DB 및 기존에 등록되어 있는 자료를 검색하여 기본정보를 자동으로 완성할 수 있습니다.<br />
...
<div id="TrackerPostGroup">
	...
	<tr>
		...
		<td class="content">
			...
			<div class="formInfo">
				프로그램 제목은 <span class="point">다음 TV프로그램 정보를 따릅니다. 가급적 다음TV검색을 사용하기를 권장</span>합니다. (예 : 무한도전, 빅 뱅 이론)<br />
				다음TV프로그램에 없는 프로그램일 경우, <span class="point">원제목을 입력</span>합니다. (예 : The Big Bang Thoery)
			</div>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			...
			<div class="formInfo">
				국내 프로그램일 입력하지 않아도 무방하나, 정식 수출된 프로그램의 경우 정식 영문 타이틀을 입력하여야 합니다.<br />
				국외 프로그램일 경우, 국외 정식 프로그램명을 입력하여야 합니다. 다음TV프로그램에 있는 경우 다음TV프로그램명을 우선시 합니다.<br />
				다음TV프로그램에 없고, 영문제목이 없는 외국영화일 경우, 해당국가의 원 제목을 원어로 입력합니다.
			</div>
		</td>
	</tr>
	<tr>
		...
		<td class="content">
			...
			<div class="formInfo">
				시즌으로 구분되어 있는 프로그램의 경우 시즌을 <span class="point">숫자로만 입력</span>하여야 합니다.<br />
				해당 시즌에 대한 공식 부제목이 있는 경우 시즌 부제목도 선택적으로 입력할 수 있습니다.
			</div>
		</td>
	</tr>
	<tr>
		<td class="header">연출<span class="pointText">*</span><br />PD<span class="pointText">*</span><input type="hidden" name="artist"></td>
		<td id="TrackerArtistSearchInputList" class="content">
			...
			<div class="formInfo">
				다음TV프로그램 DB를 참고하여, 연출자(PD)을 띄워쓰기를 포함하여 한글로 적어주십시오. (예 : 김태호, 마이클 무어)<br />
				연출자이 여러명일 경우 콤마(,)로 구분하여 입력할 수 있습니다. 가급적 연출자명 자동완성기능을 통해 입력하여 주십시오.<br />
				위의 입력폼에 <span class="point">이름을 입력하신 후 자동으로 완성된 목록을 마우스로 클릭하거나, 키보드 방향키 상/하를 눌러 원하는 목록을 찾은 뒤 엔터버튼</span>을 누르면 입력됩니다.
			</div>
		</td>
	</tr>
	<tr>
		<td class="header">출연<span class="pointText">*</span><br />Actor<span class="pointText">*</span><input type="hidden" name="subartist"></td>
		<td id="TrackerSubArtistSearchInputList" class="content">
			...
			<div class="formInfo">
				고정배우/출연자(단역, 게스트 제외)가 있을 경우 출연자명을 띄워쓰기를 포함하여 한글로 적어주십시오. (예 : 톰 크루즈, 유재석)<br />
				출연자가 여러명일 경우 콤마(,)로 구분하여 입력할 수 있습니다. 가급적 출연자명 자동완성기능을 통해 입력하여 주십시오.<br />
				위의 입력폼에 <span class="point">이름을 입력하신 후 자동으로 완성된 목록을 마우스로 클릭하거나, 키보드 방향키 상/하를 눌러 원하는 목록을 찾은 뒤 엔터버튼</span>을 누르면 입력됩니다.
			</div>
		</td>
	</tr>
...
<tr>
	...
	<td class="content">
		<textarea name="mediainfo" class="textbox" allowBlank="false">{$torrent.mediainfo}</textarea>
