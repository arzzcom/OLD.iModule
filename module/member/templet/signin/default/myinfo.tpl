...
<div class="ModuleMemberSignInDefault">
	...
	<tr>
		...
		<td class="splitBar"></td>
		<td class="bodyCell">
			<input type="text" name="{$data.type}" class="input" onblur="MemberSignInFormCheck('email');" style="width:100%;" value="{$member.email}" />
			<div class="help-block">{$data.msg}</div>
		</td>
	</tr>
	<tr class="splitBar">
	...
	<tr>
		...
		<td class="splitBar"></td>
		<td class="bodyCell">
			<input type="text" name="{$data.type}" class="input" style="width:100%;" value="{$member.homepage}" />
	...
	<tr>
		...
		<td class="bodyCell">
			...
			<input type="text" name="telephone2" class="input" maxlength="4" style="width:45px;" value="{$member.telephone.telephone2}" />
			
			<span class="inputTag">-</span>
			
			<input type="text" name="telephone3" class="input" maxlength="4" style="width:45px;" value="{$member.telephone.telephone3}" />
	...
	<tr>
		...
		<td class="bodyCell">
			...
			<input type="text" name="{$data.name}-2" class="input" maxlength="4" style="width:45px;" value="{$temp[1]}" />
			
			<span class="inputTag">-</span>
			
			<input type="text" name="{$data.name}-3" class="input" maxlength="4" style="width:45px;" value="{$temp[2]}" />
