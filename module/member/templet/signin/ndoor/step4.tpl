...
{$formStart}
<div id="SigninNdoor">
	<div style="padding:25px 0px 50px 0px;"><img src="{$skinDir}/images/title_step4.gif" /></div>
	...
	<div class="center innerimg"><input type="image" src="{$skinDir}/images/btn_join.gif" /></div>
</div>
{$formEnd}