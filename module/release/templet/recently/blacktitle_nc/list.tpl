<div class="blackTitle">
	...
	<tr class="listRow">
		<td class="listTitle"><a href="{$data.postlink}" class="listTitle"{if $mode == 'mypost' || $mode == 'myment'} onclick="return OpenBoard(this);"{/if}>{$data.title|cutstring:30:true:$data.category}</a> <span class="comment">({$data.ment}{if $data.is_newment == true}+{/if})</span></td>
