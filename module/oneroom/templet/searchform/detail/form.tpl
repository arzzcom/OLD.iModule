			...
			<div class="panel">
				...
				<tr id="DetailPriceBuy" style="display:none;">
					...
					<td class="formContent">
						...
						<tr>
							<td><input type="text" name="price_buy1" value="{$price_buy1}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 부터 </td>
							<td><input type="text" name="price_buy2" value="{$price_buy2}" style="width:65px; text-align:right;" class="inputbox" /></td>
				...
				<tr id="DetailPriceRentAll" style="display:none;">
					...
					<td class="formContent">
						...
						<col width="80" /><col width="50" /><col width="80" /><col width="100%" />
						<tr>
							<td><input type="text" name="price_rent_all1" value="{$price_rent_all1}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 부터 </td>
							<td><input type="text" name="price_rent_all2" value="{$price_rent_all2}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 까지 <span class="blue">(0을 입력하면 검색하지 않습니다.)</span></td>
						</tr>
						</table>
					</td>
				...
				<tr id="DetailPriceRentDeposit" style="display:none;">
					...
					<td class="formContent">
						...
						<col width="80" /><col width="50" /><col width="80" /><col width="100%" />
						<tr>
							<td><input type="text" name="price_rent_deposit1" value="{$price_rent_deposit1}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 부터 </td>
							<td><input type="text" name="price_rent_deposit2" value="{$price_rent_deposit2}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 까지 <span class="blue">(0을 입력하면 검색하지 않습니다.)</span></td>
						</tr>
						</table>
					</td>
				...
				<tr id="DetailPriceRentMonth" style="display:none;">
					...
					<td class="formContent">
						...
						<col width="80" /><col width="50" /><col width="80" /><col width="100%" />
						<tr>
							<td><input type="text" name="price_rent_month1" value="{$price_rent_month1}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 부터 </td>
							<td><input type="text" name="price_rent_month2" value="{$price_rent_month2}" style="width:65px; text-align:right;" class="inputbox" /></td>
							<td>만원 까지 <span class="blue">(0을 입력하면 검색하지 않습니다.)</span></td>
						</tr>
						</table>
					</td>
				...
				<tr>
					...
					<td class="formContent">
						...
						<tr>
							<td><input type="text" name="keyword" style="width:450px;" value="{$keyword}" class="inputbox" /></td>
							<td><input type="image" src="{$skinDir}/images/btn_search.gif" style="border:0px; padding:0px; background:transparent; height:20px;" class="inputbox" /></td>
						</tr>
						</table>
					</td>
				</tr>
