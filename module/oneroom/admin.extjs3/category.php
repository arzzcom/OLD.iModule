						...
						tbar:[
									...
									new Ext.Window({
										...
										buttons:[
											new Ext.Button({
												...
												handler:function() {
													Ext.getCmp("CategoryAddForm").getForm().submit({url:"<?php echo $_ENV['dir']; ?>/module/oneroom/exec/Admin.do.php?action=category&do=add&parent=0",waitMsg:"데이터를 전송중입니다."});
												}
											}),
											new Ext.Button({
												text:"취소",
							...
							new Ext.Button({
								...
								handler:function() {
									...
									Ext.Msg.show({title:"안내",msg:"선택카테고리를 삭제하게 되면 해당카테고리의 하위카테고리 및 매물도 함께 삭제됩니다.<br />정말 삭제하시겠습니까?",buttons:Ext.Msg.OKCANCEL,icon:Ext.Msg.QUESTION,fn:function(button) {
										if (button == "ok") {
									...
									new Ext.Window({
										...
										buttons:[
											new Ext.Button({
												...
												icon:"<?php echo $_ENV['dir']; ?>/module/oneroom/images/admin/icon_tick.png",
												handler:function() {
													Ext.getCmp("CategoryAddForm").getForm().submit({url:"<?php echo $_ENV['dir']; ?>/module/oneroom/exec/Admin.do.php?action=category&do=add&parent="+Ext.getCmp("Category2").getStore().baseParams.parent,waitMsg:"데이터를 전송중입니다."});
												}
											}),
											new Ext.Button({
												text:"취소",
									...
									new Ext.Window({
										...
										buttons:[
											new Ext.Button({
												...
												icon:"<?php echo $_ENV['dir']; ?>/module/oneroom/images/admin/icon_tick.png",
												handler:function() {
													Ext.getCmp("CategoryAddForm").getForm().submit({url:"<?php echo $_ENV['dir']; ?>/module/oneroom/exec/Admin.do.php?action=category&do=add&parent="+Ext.getCmp("Category3").getStore().baseParams.parent,waitMsg:"데이터를 전송중입니다."});
												}
											}),
											new Ext.Button({
												text:"취소",
