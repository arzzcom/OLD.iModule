...
ContentArea = function(viewport) {
	...
	var store1 = new Ext.data.Store({
		...
		reader:new Ext.data.JsonReader({
			...
			fields:["idx","region","agent","category","status","title","areasize","price_type","price","hit"]
		}),
		remoteSort:true,
		sortInfo:{field:"idx",direction:"DESC"},
		baseParams:{action:"item",get:"list",agent:"0",dealer:"0",region1:"0",region2:"0",region3:"0",category1:"0",category2:"0",category3:"0",keyword:""},
	...
	var ItemFunction = function(idx) {
		new Ext.Window({
			...
			items:[
				new Ext.form.FormPanel({
					...
					reader:new Ext.data.XmlReader(
						...
						["agent","dealer","category1","category2","category3","region1","region2","region3","title","is_rent_month","is_rent_all","is_buy","is_rent_short","price_rent_deposit","price_rent_month","price_rent_all","price_buy","price_maintenance","floor1","floor2","is_under","rooms","is_double","parkings","areasize1","real_areasize1","build_year","movein_date","movein_date_now","zipcode","address1","address2","subway1","subway2","subway_distance","university1","university2","options","default_image","detail"]
					),
					items:[
						new Ext.form.Hidden({
							name:"options"
									...
									items:[
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("agent").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("agent").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("agent").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("agent").setValue(Ext.getCmp("ItemForm").getForm().findField("agent").getValue());
													}
												}}}
											}),
											width:100,
										...
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												remoteSort:false,
												sortInfo:{field:"sort",direction:"ASC"},
												baseParams:{"action":"dealer","get":"list","agent":"-1","status":"ACTIVE"},
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("dealer").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("dealer").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("dealer").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("dealer").setValue(Ext.getCmp("ItemForm").getForm().findField("dealer").getValue());
													}
												}}}
											}),
											width:80,
									...
									items:[
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												liteners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("category1").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("category1").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("category1").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("category1").setValue(Ext.getCmp("ItemForm").getForm().findField("category1").getValue());
													}
												}}}
											}),
											width:100,
										...
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("category2").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("category2").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("category2").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("category2").setValue(Ext.getCmp("ItemForm").getForm().findField("category2").getValue());
													}
												}}}
											}),
											width:100,
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function() {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("category2").getValue(),false,false) == -1) {
														...
														Ext.getCmp("ItemForm").getForm().findField("category3").setValue(Ext.getCmp("ItemForm").getForm().findField("category3").getValue());
													}
												}}}
											}),
											width:100,
									...
									items:[
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												liteners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("region1").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("region1").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("region1").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("region1").setValue(Ext.getCmp("ItemForm").getForm().findField("region1").getValue());
													}
												}}}
											}),
											width:100,
										...
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("region2").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("region2").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("region2").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("region2").setValue(Ext.getCmp("ItemForm").getForm().findField("region2").getValue());
													}
												}}}
											}),
											width:100,
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("region2").getValue(),false,false) == -1) {
														...
														Ext.getCmp("ItemForm").getForm().findField("region3").setValue(Ext.getCmp("ItemForm").getForm().findField("region3").getValue());
													}
												}}}
											}),
											width:100,
									...
									items:[
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("subway1").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("subway1").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("subway1").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("subway1").setValue(Ext.getCmp("ItemForm").getForm().findField("subway1").getValue());
													}
												}}}
											}),
											width:100,
										...
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("subway2").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("subway2").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("subway2").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("subway2").setValue(Ext.getCmp("ItemForm").getForm().findField("subway2").getValue());
													}
												}}}
											}),
											width:80,
									...
									items:[
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("university1").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("subway1").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("subway1").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("university1").setValue(Ext.getCmp("ItemForm").getForm().findField("university1").getValue());
													}
												}}}
											}),
											width:100,
										...
										new Ext.form.ComboBox({
											...
											store:new Ext.data.Store({
												...
												listeners:{load:{fn:function(store) {
													if (store.find("idx",Ext.getCmp("ItemForm").getForm().findField("university2").getValue(),false,false) == -1) {
														Ext.getCmp("ItemForm").getForm().findField("university2").setValue("");
														Ext.getCmp("ItemForm").getForm().findField("university2").clearInvalid();
													} else {
														Ext.getCmp("ItemForm").getForm().findField("university2").setValue(Ext.getCmp("ItemForm").getForm().findField("university2").getValue());
													}
												}}}
											}),
											width:80,
					...
					listeners:{actioncomplete:{fn:function(form,action) {
						...
						if (action.type) {
							...
							form.findField("agent").fireEvent("select",form.findField("agent"));
							
							form.findField("category1").fireEvent("select",form.findField("category1"));
							if (form.findField("category2").getValue() != "") form.findField("category2").fireEvent("select",form.findField("category2"));
							
							form.findField("region1").fireEvent("select",form.findField("region1"));
							if (form.findField("region2").getValue() != "") form.findField("region2").fireEvent("select",form.findField("region2"));
							
							form.findField("price_rent_deposit").fireEvent("blur",form.findField("price_rent_deposit"));
							form.findField("price_rent_month").fireEvent("blur",form.findField("price_rent_month"));
							form.findField("price_rent_all").fireEvent("blur",form.findField("price_rent_all"));
							form.findField("price_buy").fireEvent("blur",form.findField("price_buy"));
							form.findField("price_maintenance").fireEvent("blur",form.findField("price_maintenance"));
							
							form.findField("areasize1").fireEvent("blur",form.findField("areasize1"));
							form.findField("real_areasize1").fireEvent("blur",form.findField("real_areasize1"));

							if (form.findField("subway1").getValue() != "") form.findField("subway1").fireEvent("select",form.findField("subway1"));
							
							if (form.findField("university1").getValue() != "") form.findField("university1").fireEvent("select",form.findField("university1"));

							if (form.findField("options").getValue().split(",").length > 0) {
								var options = form.findField("options").getValue().split(",");
								for (var i=0, loop=options.length;i<loop;i++) {
									if (Ext.getCmp("options_"+options[i])) Ext.getCmp("options_"+options[i]).setValue("on");
								}
							}
						}
					}}}
			...
			listeners:{show:{fn:function() {
				new AzUploader({
					...
					listeners:{
						...
						onLoad:function(uploader,file) {
							...
							var defaultImage = document.getElementById("AttachImageList").getElementsByTagName("input");
							for (var i=0, loop=defaultImage.length;i<loop;i++) {
								if (defaultImage[i].value == Ext.getCmp("ItemForm").getForm().findField("default_image").getValue()) {
									defaultImage[i].checked = true;
									isSelectImage = true;
									break;
								}
							}
				...
				if (idx) {
					Ext.getCmp("ItemForm").getForm().load({url:"<?php echo $_ENV['dir']; ?>/module/oneroom/exec/Manager.get.php?action=item&get=data&idx="+idx,waitMsg:"정보를 로딩중입니다."});
				}
			}}}
		}).show();
	}
												...
												items:[
													...
													new Ext.form.ComboBox({
														...
														store:new Ext.data.Store({
															...
															remoteSort:false,
															sortInfo:{field:"sort",direction:"ASC"},
															baseParams:{"action":"dealer","get":"list","get":"list","agent":"-1","status":"ACTIVE"},
															listeners:{load:{fn:function() {
						...
						cm:new Ext.grid.ColumnModel([
							new Ext.grid.CheckboxSelectionModel(),
							{
								...
								renderer:function(value) {
									if (value == "WAIT") return "계약대기";
									else return "<span class='blue'>계약완료</span>";
								}
							},{
								header:"매물명",
								dataIndex:"title",
								...
								width:80,
								renderer:function(value,p,record) {
									if (value) return '<div style="text-align:right;">'+GetNumberFormat(value)+"만원</div>"
								}
							},{
								header:"가격정보",
